...
proj_dir='/home/rwkv/JL/out_model/world-qa-cn-step1'
data_file='/home/rwkv/JL/audio-data/cn_wav'
...
--my_testing "x070" --train_step moda adapter --wandb world-qa